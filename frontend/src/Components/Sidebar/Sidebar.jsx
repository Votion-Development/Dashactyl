          ...
          >
            ...
            <ul className="md:flex-col md:min-w-full flex flex-col list-none">
              <li className="items-center">
                <Link className="text-xs uppercase py-3 font-bold block " to="/dashboard">
              ...
              <li className="items-center">
                <Link className="text-xs uppercase py-3 font-bold block " to="/dashboard/afk">
                  <i className="fas fa-tv mr-2 text-sm "></i>{" "}
                  AFK Page
                </Link>
              </li>
              ...
              <li className="items-center">
                <Link className="text-xs uppercase py-3 font-bold block " to="/dashboard/store">
                  <i className="fas fa-tv mr-2 text-sm "></i>{" "}
                  Store
                </Link>
              </li>
              ...
              <li className="items-center">
                <Link className="text-xs uppercase py-3 font-bold block " to="/dashboard/create">
                  <i className="fas fa-tv mr-2 text-sm "></i>{" "}
                  Create Server
                </Link>
              </li>
              {isLoading
                ...
                pteroUser.attributes.root_admin
                  ?
                  <li className="items-center">
                    <Link className="text-xs uppercase py-3 font-bold block " to="/dashboard/admin">
                      <i className="fas fa-tv mr-2 text-sm "></i>{" "}
                      Admin Area
                    </Link>
                  </li>
