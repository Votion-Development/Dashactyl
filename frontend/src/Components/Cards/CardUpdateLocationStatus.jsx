                                    ...
                                    <div className="relative z-0 w-full mb-6 group">
                                        ...
                                        <select id="location" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                                            {locations.map((location) =>
                                                <option value={location.id}>{location.name} - Currently Enabled: {location.enabled}</option>
                                            )}
                                        </select>
                                    </div>
                                    <div class="relative z-0 w-full mb-6 group">
                                        <label for="status" className="block mb-2 text-sm text-black">Status</label>
                                        <select id="status" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                                            <option>true</option>
                                            <option>false</option>
                                        </select>
                                    </div>
