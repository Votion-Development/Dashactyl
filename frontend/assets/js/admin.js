async function userInfo(id) {
    ...
    let req = await fetch(`/api/users/info/${id}`, {
        method: "get"
    });
...
async function blacklistUser(id) {
    ...
    let req = await fetch(`/api/users/blacklist/${id}`, {
        method: "post"
    });
...
async function unblacklistUser(id) {
    ...
    let req = await fetch(`/api/users/unblacklist/${id}`, {
        method: "post"
    });
...
async function setCoins(id, coins, add_coins) {
    ...
    let req = await fetch(`/api/users/${add_coins ? "add" : "set"}_coins/${id}`, {
        method: "post",
        headers: {
...
async function setPackage(id, package) {
    ...
    let req = await fetch(`/api/resources/set_package/${id}`, {
        method: "post",
        headers: {
            'Content-Type': 'application/json',
            Accept: "application/json"
...
async function setResources(id, memory, disk, cpu, servers, add_resources) {
    ...
    let req = await fetch(`/api/resources/${add_resources ? "add" : "set"}_resources/${id}`, {
        method: "post",
        headers: {
            'Content-Type': 'application/json',
            Accept: "application/json"
...
async function createCoupon(code, coins, memory, disk, cpu, servers) {
    let req = await fetch(`/api/coupons/create_coupon`, {
        method: "post",
        headers: {
            'Content-Type': 'application/json',
            Accept: "application/json"
...
async function revokeCoupon(code) {
    ...
    let req = await fetch(`/api/coupons/revoke_coupon/${code}`, {
        method: "delete",
        headers: {
            'Content-Type': 'application/json',
            Accept: "application/json"
...
async function createJ4R(j4r_id, server_id, days, memory, disk, cpu, servers) {
    let req = await fetch(`/api/j4r/create`, {
        method: "post",
        headers: {
            'Content-Type': 'application/json',
            Accept: "application/json"
